              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col gap-3 pt-4 border-t border-stone-50">
                    <div className="flex flex-col gap-1.5 text-stone-500 font-medium text-[10px] uppercase tracking-wider">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>{event.stats.date}</span>
                      </div>
                    </div>
                    <Link href={`/events/${event.id}`} className="text-orange-600 font-bold text-sm flex items-center gap-1 mt-2">

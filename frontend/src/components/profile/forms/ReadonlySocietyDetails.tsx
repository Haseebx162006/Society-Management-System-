...
export default function ReadonlySocietyDetails({ request, onReapply }: { request: { society_name: string, status: string, form_data: RegistrationFormData, rejection_reason?: string }, onReapply?: () => void }) {
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
               <h4 className="text-red-800 font-bold">Registration Request Rejected</h4>

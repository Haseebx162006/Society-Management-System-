  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-stone-400 mt-1">Societies you are a part of</p>
      </div>
            ...
            <div key={i} className="rounded-2xl border border-stone-100 p-6 animate-pulse">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-2 flex-1">
                  ...
                  <div className="h-3 w-48 bg-stone-100 rounded-lg" />
                </div>
              </div>
            </div>
          ))}
      ...
      {!isLoading && !error && (!societies || societies.length === 0) && (
        <div className="text-center py-16">
          <div className="w-20 h-20 rounded-2xl bg-stone-50 flex items-center justify-center mx-auto mb-5">
          ...
          <h3 className="text-lg font-semibold text-stone-900 mb-1">No societies yet</h3>
                    ...
                    {myTeams.length > 0 && (
                        <div className="flex flex-wrap gap-2 mt-2">
                             {myTeams.map(team => {
                                 ...
                                 return (
                                     <span key={team._id} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-stone-100 text-stone-600 border border-stone-200">
                                         {groupName}
                                     </span>
                                 );
                             })}

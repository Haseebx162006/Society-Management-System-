    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-stone-400 mt-1">Manage your personal information</p>
        </div>
        {!isEditing && (
          <button
            onClick={() => {
      ...
      <div className="bg-orange-600 rounded-2xl p-8 flex items-center gap-6">
        <div className="w-20 h-20 rounded-2xl bg-stone-50/20 backdrop-blur-sm flex items-center justify-center text-white text-3xl font-bold shadow-lg border border-white/20">
      ...
      <div className="grid gap-6">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="px-4 py-3 rounded-xl bg-stone-50/80 text-stone-500 text-sm font-medium border border-stone-100">
              {currentUser.email}
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            {isEditing ? (
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-stone-200 bg-stone-50/50 text-stone-900 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#021e66]/20 focus:border-[#021e66]/40 transition-all duration-300 placeholder:text-stone-300"
              />
            ) : (
              <p className="px-4 py-3 rounded-xl bg-stone-50/80 text-stone-900 text-sm font-medium border border-stone-100">
          ...
          <div>
            ...
            <div className="px-4 py-3 rounded-xl bg-stone-50/80 border border-stone-100 flex items-center gap-2">
      ...
      {isEditing && (
        <div className="flex items-center gap-3 pt-2">
          ...
          <button
            ...
            className="px-6 py-3 text-sm font-semibold text-stone-600 rounded-xl bg-stone-100 hover:bg-stone-200 transition-all duration-300"
          >
            Cancel
          </button>
        </div>

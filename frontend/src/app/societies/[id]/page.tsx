...
export default function SocietyDetailsPage() {
  ...
  if (!society) {
    ...
    const seed = society._id.split('').reduce((acc: number, char: string) => acc + char.charCodeAt(0), 0);
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-end pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div 
            ...
            style={{ 
              backgroundImage: `url(${society.logo || "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=2070"})` 
            }}
          />
        ...
        <div className="container mx-auto px-6 relative z-10 w-full">
            ...
            >
                ...
                <div className="flex flex-wrap gap-4">
                    <button className="px-8 py-4 bg-white text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 shadow-xl hover:shadow-2xl flex items-center gap-2">
                        <span>Register Now</span>
                        <span className="bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded text-sm group-hover:bg-indigo-200 transition-colors">
              ...
              <div className="flex flex-wrap items-center justify-between gap-8">
                  <div className="flex gap-8 md:gap-16">
                      <div className="flex items-center gap-3">
                          ...
                          <div>
                              <p className="text-sm text-gray-500 font-semibold uppercase tracking-wide">Members</p>
                      ...
                      <div className="flex items-center gap-3">
                          ...
                          <div>
                              <p className="text-sm text-gray-500 font-semibold uppercase tracking-wide">Events</p>
                  ...
                  <div className="flex gap-4">
                      {[Instagram, Twitter, Linkedin, Facebook, Globe].map((Icon, i) => (
                          <a key={i} href="#" className="p-2 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-12">
                  <div className="prose prose-lg prose-indigo max-w-none">
                      ...
                      {society.content_sections?.length > 0 && society.content_sections.map((section: any, index: number) => (
                          ...
                          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                              {society.custom_fields.map((field: any, index: number) => (
                                  <div key={index} className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                      <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">{field.label}</p>
                  ...
                  <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                          {(society.why_join_us && society.why_join_us.length > 0 ? society.why_join_us : [
              ...
              <div className="space-y-8">
                  ...
                  {/* Teams / Executive Board Widget */}
                  <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                      <h3 className="text-lg font-bold text-gray-900 mb-6">Our Teams</h3>
                      <div className="space-y-4">
                          {(society.groups && society.groups.length > 0 ? society.groups : [
                  ...
                  <div className="bg-gray-900 rounded-2xl p-6 text-white shadow-xl">
                      ...
                      <ul className="space-y-4">
                          <li className="flex items-start gap-4">
                              ...
                              <span className="text-gray-300 text-sm">Student Service Center, COMSATS University Lahore Campus</span>
                          </li>
                          <li className="flex items-center gap-4">
                              <Mail className="w-5 h-5 text-indigo-400 shrink-0" />
                              <a href={`mailto:${society.contact_info?.email || `contact@${society.name.toLowerCase().replace(/\s/g, '')}.com`}`} className="text-gray-300 text-sm hover:text-white transition-colors break-all">
                                  {society.contact_info?.email || `contact@${society.name.toLowerCase().replace(/\s/g, '')}.com`}
                              </a>
                          </li>
                          {society.contact_info?.phone && (
                              <li className="flex items-center gap-4">
                                  <div className="w-5 h-5 flex items-center justify-center text-indigo-400 shrink-0">📞</div>
                                  <span className="text-gray-300 text-sm">{society.contact_info.phone}</span>
                              </li>
                          )}
                           {society.contact_info?.website && (
                              <li className="flex items-center gap-4">
                                   <Globe className="w-5 h-5 text-indigo-400 shrink-0" />
                                  <a href={society.contact_info.website} target="_blank" rel="noopener noreferrer" className="text-gray-300 text-sm hover:text-white transition-colors break-all">
                                      Visit Website
                                  </a>
                              </li>
                          )}

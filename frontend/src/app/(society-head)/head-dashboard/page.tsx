...
export default function SocietyHeadOverviewPage() {
  ...
  const doughnutOptions = {
    ...
    cutout: "72%",
    plugins: {
      legend: { position: "bottom" as const, labels: { color: "#78716c", font: { size: 12, weight: 500 }, padding: 16, usePointStyle: true, pointStyleWidth: 8 } },
  ...
  return (
    <div className="space-y-8 font-(--font-family-poppins)">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
        ...
        <StatCard label="Platform Members" value={2498} icon={Users} trend="up" trendLabel={`+${membersByMonth.datasets[0].data.slice(-1)[0] || 0} this month`} accent="from-orange-50/80 to-transparent" delay={0.07} href="/head-dashboard/members" />

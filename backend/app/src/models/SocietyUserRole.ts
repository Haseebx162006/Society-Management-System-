...
export interface ISocietyUserRole extends Document {
    ...
    role: "PRESIDENT" | "LEAD" | "CO-LEAD" | "SPONSOR MANAGER" | "MEMBER" | "FINANCE MANAGER" | "EVENT MANAGER";
...
const societyUserRolesSchema: Schema = new Schema({
    ...
    role: {
        type: String,
        enum: ["PRESIDENT", "LEAD", "CO-LEAD", "SPONSOR MANAGER", "MEMBER", "FINANCE MANAGER", "EVENT MANAGER"],
        default: "MEMBER"
    },
    group_id: {
        type: mongoose.Schema.Types.ObjectId,
